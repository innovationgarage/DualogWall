- new post-its need to croped and added to crop_source/ 
- the corresponding text needs to be added to crop_source/ (with the same base name as the post-it image file)
